...
Na správne fungovanie programu je nutné aby bol nastavený názov primárneho kľúča v tabuľkách. V prípade, že je iný ako '_record_id' je nutné upraviť hodnotu premennej PRIMARY_KEY_NAME v súbore lib/datanest.rb
